...
/**
 * PCS Paste Condition Demo
 * 
 * Interactive demonstration showing three enforcement conditions:
 * 1. PCS-OFF: No policy, no enforcement (baseline)
 * 2. PASTE: Policy in prompt, no structural enforcement
 * 3. PCS-ON: Structural enforcement with cryptographic audit trail
 * 
 * This demonstrates the core architectural claim:
 * "Information presence ≠ deterministic authority"
 * 
 * Usage:
 *   node demo-paste-condition.js
 * 
 * Requirements:
...
class PasteConditionDemo {
  ...
  async run() {
    console.log('═══════════════════════════════════════════════════════════════');
    console.log('  PCS PASTE CONDITION DEMONSTRATION');
    console.log('═══════════════════════════════════════════════════════════════\n');
  ...
  async runCondition2_Paste(caseData, excludedVendor, policyId) {
    ...
    console.log('  Information presence ≠ deterministic authority.\n');
  ...
  printSummary() {
    ...
    console.log('Architectural Insight:');
    console.log('─────────────────────────────────────────────────────────────');
    console.log('PCS demonstrates that governance enforcement is an architectural');
    console.log('property, not a model capability or prompt engineering technique.');
    console.log('');
...
async function main() {
  try {
    const demo = new PasteConditionDemo();
    await demo.run();
